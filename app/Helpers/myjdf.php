...
/*	F	*/
function custom_jdate($format, $timestamp='', $none='', $time_zone='Asia/Tehran', $tr_num='fa'){
  ...
  if($m===''){
   ...
   if($s===''){
    ...
    if($jm===''){
     ...
     $jdate=explode('_',custom_jdate('Y_j','','',$timezone,'en'));
     if($jd===''){
...
function jgetdate($timestamp='',$none='',$timezone='Asia/Tehran',$tn='en'){
 ...
 $jdate=explode('_',custom_jdate('F_G_i_j_l_n_s_w_Y_z',$ts,'',$timezone,$tn));
 return array(
