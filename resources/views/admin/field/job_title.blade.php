...
@section('page')
    ...
    <div class="widget has-shadow">
        <div class="widget-header bordered no-actions d-flex align-items-center" style="position: relative">
            <h4>لیست عناوین شفلی</h4>
            <a href="{{route('job_title.update')}}" title="به روز رسانی لیست" style="position: absolute;left: 20px;"><i
                ...
                <table class="table mb-0">
                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td class="text-center">{!! App\Helpers\getCountOfSubscribersJobField( $item->cat_id) !!}</td>
