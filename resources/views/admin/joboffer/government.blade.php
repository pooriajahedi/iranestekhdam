...
@section('page')
    ...
    <div class="widget has-shadow">
        <div class="widget-header bordered no-actions d-flex align-items-center" style="position: relative">
            <h4>موقعیت های استخدامی سازمان های دولتی</h4>
            <a href="{{route('government_job_offer.update')}}" title="به روز رسانی لیست" style="position: absolute;left: 20px;"><i
                ...
                <table class="table mb-0">
                    ...
                    @foreach($list as $item)
                        <tr>
                            ...
                            <td class="text-center">{!! \App\Helpers\getJobOfferLink( $item->guid) !!}</td>
                        </tr>
                    @endforeach
                    </tbody>
                </table>
